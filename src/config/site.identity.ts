export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'esohbetsitesi',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Esohbetsitesi',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'esohbetsitesi.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://esohbetsitesi.com',
