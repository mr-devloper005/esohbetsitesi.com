...
export const visualSystem = {
  ...
  motion: {
    ...
    cardHover: 'transition duration-300 hover:-translate-y-1 hover:shadow-[0_12px_36px_rgba(15,27,76,0.14)]',
  ...
  typography: {
    ...
    heroTitle: 'text-4xl font-extrabold italic tracking-[-0.02em] sm:text-5xl lg:text-6xl',
    sectionTitle: 'text-3xl font-extrabold italic tracking-[-0.02em] sm:text-4xl',
    body: 'text-base leading-relaxed',
    caption: 'text-xs font-bold uppercase tracking-[0.12em]',
  },
  surfaces: {
    glass: 'border border-white/15 bg-white/10 backdrop-blur-xl',
    paper: 'rounded-2xl border border-[var(--editable-border)] bg-white shadow-[0_2px_8px_rgba(15,27,76,0.06)]',
    quiet: 'rounded-2xl border border-[var(--editable-border)] bg-[var(--slot4-panel-bg)]',
    dark: 'rounded-2xl border border-white/10 bg-[var(--slot4-dark-bg)] shadow-[0_8px_30px_rgba(15,27,76,0.12)]',
  },
  layout: {
